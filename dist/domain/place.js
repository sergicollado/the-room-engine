...
const { Feature } = require("./interactiveObjects/interactiveObjects");
const Place = ({ id, description, smallDescription, objects = [] }) => {
    ...
    let interactiveObjects = objects.map((element) => interactiveObjectMapper(Object.assign(Object.assign({}, element), { sentenceReplacer })));
    ...
    const getDescription = () => {
        ...
        return Object.assign(Object.assign({}, description), { text: replacedText });
    };
    return {
        id,
        description,
