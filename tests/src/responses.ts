import { InputResponsesSettings } from "../../src/inputConfig/inputResponsesSettings";

export const responses:InputResponsesSettings = {
  ...
  ALREADY_OPEN_MESSAGE: {text: "This is already open"},
}
